...
cl = TOBY.LINE()
cl.login(token='ElYd1FWCNwfY8LjHXq6e.nLYmW5kuoITlKIaMtxcqtG.uKZng2iF9w4q58cdG0RkfwQm5/9OEGPjNIpOzn5mdZc=')
cl.loginResult()
...
馃懝 HANYA ADMIN YANG BISA MENGGUNAKAN COMMAND 馃懣
"""
KAC=[cl,ki,kk,kc]
...
admin=["ua7fb5762d5066629323d113e1266e8ca"]
wait = {
    'contact':False,
    'autoJoin':True,
...
#-----------------------------------------------
				...
				ki.sendText(msg.to,"Owner : line.me/ti/p/~tobyg74")
